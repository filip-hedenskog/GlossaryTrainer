...
internal static class GlossaryRepo
{
    ...
    [
        ...
        new("Section 4, unit 26 - Discuss weather", [
            ...
            new("The weather is a little bad today. (As for today, the weather is a little bad.)", ["今日は天気が少し悪いです。", "今日は天気がちょっと悪いです。", "今日は天気があまりよくないです。", "今日は天気は少し悪いです。", "今日は天気はちょっと悪いです。", "今日は天気はあまりよくないです。"]),
            new("The weather is not good this month. (As for this month, the weather is not good.)", ["今月は天気がよくないです。", "今月は天気はよくないです。"]),
            ...
            new("The sky is bright tonight. (As for tonight, the sky is bright.)", ["今晩は空が明るいです。", "今夜は空が明るいです。", "今晩は空は明るいです。", "今夜は空は明るいです。"]),
            ...
            new("Isn't the wind weak today? (use negation of adjective)", ["今日は風が弱くないですか。", "今日は風は弱くないですか。"]),
            new("Isn't the wind weak today? (use existence)", ["今日は風が弱くありませんか。", "今日は風は弱くありませんか。"]),
...
new("Section 4, unit 22 - Describe extended family", [
    ...
    new("Section 4, unit 16 - Talk about your family", [
            ...
            new("She is my older sister. (girl perspective)", ["かのじょは私のあねです。", "彼女は私の姉です。"]),
