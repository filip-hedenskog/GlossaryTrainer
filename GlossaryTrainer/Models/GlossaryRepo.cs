...
internal static class GlossaryRepo
{
    ...
    [
        new("Section 4, unit 31 - Shop for common items", [
            ...
            new("I buy all sorts of things.", ["色々買います。"]),
            ...
            new("There are all sorts of bags in this store.", ["この店は色々な鞄があります。", "この店は鞄が色々あります。"]),
            ...
            new("(I) bought a sturdy watch.", ["丈夫な腕時計を買いました。"]),
            new("Take good care of it./Cherish it./ Treat it carefully. (soft, friendly)", ["大切にして", "大切にしてください"]),
            new("(I) will put the wristwatch in the bag.", ["腕時計を鞄に入れます。"]),
