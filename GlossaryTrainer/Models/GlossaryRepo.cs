...
internal static class GlossaryRepo
{
    ...
    new("Section 4, unit 19 - Say where things are", [
            ...
            new("There are four books on the bookshelf. (introduce books first, not the shelf)", ["本が本だなに四さつあります。", "本が本棚に四冊あります。"]),
    ...
    new("Section 4, unit 16 - Talk about your family", [
            ...
            new("Whose computer is this?", ["このパソコンはだれのですか。", "このパソコンは誰のですか。"]),
    ...
    new("Section 4, unit 14 - Describe your home", [
            ...
            new("There are three windows in the room. (emphasize+contrast)", ["部屋には窓が三つあります。"]),
        ]),
    ...
    new("Section 4, unit 12 - Discuss a meal", [
            ...
            new("It's exactly ten thirty right now.", ["今ちょうど十時半です。","今十時半ちょうどです。"]),
            new("Well then, let's go to Shibuya. (formal/polite version)", ["では、渋谷に行きましょう。"]),
    ...
    new("Section 4, unit 11 - Communicate at a store", [
        ...
        new("Practice sentences",[
            ...
            new("How old are you turning next week?", ["来週何歳にありますか。"]),
            //new("", ["", ""]),
        ]),
    ];
